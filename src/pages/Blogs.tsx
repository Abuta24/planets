...
export default function Blogs() {
  ...
  const newData = data.find((el) => el.name === planetName);

  const [num, setNum] = useState(1);

  return (
    <div>
      <h1 className="pname">{newData?.name}</h1>
      {num === 1 ? (
        <p className="pdesc">{newData?.overview.content}</p>
      ) : num === 2 ? (
        <p className="pdesc">{newData?.structure.content} </p>
      ) : (
        <p className="pdesc">{newData?.geology.content}</p>
      )}
      <h1 className="source">
        Source :
        <span>
          <a href={newData?.geology.source} target="blank">
            Wikipedia
          </a>
        </span>
      </h1>
      {num === 1 ? (
        ...
        <img src={newData?.images.internal} alt="" />
      ) : (
        <img src={newData?.images.geology} alt="" />
      )}
      <div className="select">
        <button
          ...
          className="zurabi"
          style={{backgroundColor: num === 1 ? "#419EBB" : "transparent"}}
        >
          01 OVERVIEW
        </button>
        <button
          ...
          className="zurabi"
          style={{backgroundColor: num === 2 ? "#419EBB" : "transparent"}}
        >
        ...
        <button
          ...
          className="zurabi"
          style={{backgroundColor: num === 3 ? "#419EBB" : "transparent"}}
        >
          03 Surface Geology
        </button>
      </div>
      <footer>
        <div className="footer">
          <h1 className="ftxt">Rotation Time</h1>
          <h1 className="ftxt1">{newData?.rotation}</h1>
        </div>
        <div className="footer">
          <h1 className="ftxt">REVOLUTION TIME</h1>
          <h1 className="ftxt1">{newData?.revolution}</h1>
        </div>
        <div className="footer">
          <h1 className="ftxt">radius</h1>
          <h1 className="ftxt1">{newData?.radius}</h1>
        </div>
        <div className="footer">
          <h1 className="ftxt">AVERAGE TEMP.</h1>
          <h1 className="ftxt1">{newData?.temperature}</h1>
        </div>
      </footer>
    </div>
  );
